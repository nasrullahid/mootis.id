  ...
  <div class="page-post">
    <div class="banner">
      <div class="banner__img">
        <app-img :src="`/artikel/${blog.banner}`" :alt="blog.title" />
      </div>
    </div>
    <div class="max-w-4xl mx-auto pb-12 px-4">
      <article class="blog-post">
        ...
        <div class="blog-post__date">
          ...
          <span>
            {{ Math.ceil(blog.readingTime.minutes.toFixed(2)) }} menit
          </span>
        </div>

        <div class="blog-post__content">
          <!-- {{ blog.content }} -->
          <h3 class="m-0 mb-4">What is Lorem Ipsum?</h3>
          <p>
...
export default {
  ...
  created() {
    ...
    const fullPath = `${env.hostname}/artikel/${slug}`
    const content =
    ...
    this.blog = {
      ...
      keywords: 'mootis.id, properti syariah, lorem ipsum',
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          name: 'og:url',
          property: 'og:url',
          content: `${env.hostname}/artikel/${this.blog.slug}`
        },
        {
          hid: 'og:image',
          name: 'og:image',
      ...
      link: [
        {
          ...
          title: `${this.blog.title} - ${env.appName}`
        }
      ]
    }
  }
...
.blog-post {
  ...
  &__title {
    @apply capitalize font-bold text-2xl leading-normal p-8;
  }
  ...
  &__content {
    @apply leading-normal mb-0 p-8 text-justify;
  }
}
