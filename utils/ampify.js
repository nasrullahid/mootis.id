import { GOOGLE_ANALYTIC } from '../constant'

const ampScript =
  '<script async src="https://cdn.ampproject.org/v0.js"></script>'
const ampAnalyticsScript =
  '<script async custom-element="amp-analytics" src="https://cdn.ampproject.org/v0/amp-analytics-0.1.js"></script>'
const ampVideoScript =
...
const ampAnalytics = `<amp-analytics type="gtag" data-credentials="include"><script type="application/json">{"vars":{"gtag_id":"${GOOGLE_ANALYTIC}","config":{"${GOOGLE_ANALYTIC}":{"groups":"default"}}}}</script></amp-analytics>`
